create table reservation (id bigint not null auto_increment, ending_time datetime not null, last_modified_at datetime, reservation_date date not null, reserved_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP not null, starting_time datetime not null, status integer, seat_id bigint, user_id bigint, primary key (id))
